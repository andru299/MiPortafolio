    ...
    const onSubmit = (e) => {
        ...
        if(contactDates.name==="" || 
           ...
           contactDates.checkedTerms===false){
            ...
            emailjs.sendForm(
                'service_40khhoe', "REACT_APP_EMAILJS_SERVICE_ID=service_40khhoe",  //AQUí va su ID DE SERVICIO EMAILJS
                'template_m04bdmu', "REACT_APP_EMAILJS_TEMPLATE_ID=template_m04bdmu", //AQUÍ VA EL TEMPLATE ID
                form.current,
                'VpMdQcKkvjOFbUTus', "REACT_APP_EMAILJS_PUBLIC_USER_ID=VpMdQcKkvjOFbUTus"
                //AQUÍ VA LA PUBLIC KEY
            ).then(
                (result) =>{
